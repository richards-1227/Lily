 ...
 //   int noSeq{static_cast<int>(seqArray.size())};
   ...
   /* std::vector<std::string> treeList{};
    ...
    tbb::parallel_for( tbb::blocked_range<int>(0,seqArray.size()-2),
        ...
        std::vector<std::string> seq2{seqArray2[species1], seqArray2[species2], seqArray2[species3]};
        std::vector<int> countArray{getCounts(seq2)};

                    double rootAge{};
                    
                    std::vector<int> pair1{pairCounts(seqArray2[species1], seqArray2[species2])};
                    std::vector<int> pair2{pairCounts(seqArray2[species1], seqArray2[species3])};
                    std::vector<int> pair3{pairCounts(seqArray2[species2], seqArray2[species3])};
